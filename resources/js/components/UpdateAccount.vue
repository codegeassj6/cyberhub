                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-4 mb-xl-0">
                                ...
                                <div class="card-body text-center">
                                        ...
                                        <img class="img-account-profile rounded-circle mb-2" width="300" height="300" :src="form.photo" id="myPhoto" alt="">
                                        <!-- Profile picture help block-->
                                        <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                                        <!-- Profile picture upload button-->
                                        <input type="file" class="d-none" @change="inputFile" id="input_upload" accept="image/png, image/jpg, image/jpeg" />

                                        <template v-if="form.boolUpload">
                                            <button class="btn btn-primary" @click="uploadTriggerInput" type="button">Upload Image</button>
                                        </template>

                                        <template v-else>
                                            <button class="btn btn-danger" type="button" @click="cancelUpload">Cancel</button>
                                    ...
                                    <form>
                                        ...
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="text" v-model="form.first_name" placeholder="Enter your first name">
                                            </div>
                                            <!-- Form Group (last name)-->
                                            <div class="col-md-6">
                                                <label class="small mb-1" for="inputLastName">Last name</label>
                                                <input class="form-control" v-model="form.last_name" type="text" placeholder="Enter your last name" value="Luna">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" v-model="form.email" type="email" placeholder="Enter your email address" disabled>
                                        </div>
                                        <!-- Form Row-->
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" type="text" v-model="form.contact" placeholder="Enter your phone number">
                                            </div>
                                            <!-- Form Group (birthday)-->
                                            <div class="col-md-6">
                                        ...
                                        <!-- Save changes button-->
                                        <button class="btn btn-primary" @click="updateProfile" type="button">Save changes</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        uploadImage() {
            ...
            axios.post('/api/account/update/image',formData, { headers: {Authorization: AuthStr} })
            .then((res) => {
                this.form.boolUpload = true;

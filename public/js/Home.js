  ...
  methods: {
    ...
    editPost: function editPost(data) {
      ...
      axios({
        ...
        document.getElementById("post_message_".concat(data.id)).innerText = _this2.$refs.edit_message.innerText;
      })["catch"](function (err) {});
    }
  },
  watch: {
                          ...
                          [
                            _c(
                              "div",
                              {
                                ref: "edit_message",
                                staticClass:
                                  "flex-fill p-2 min-100 div-like-pre",
